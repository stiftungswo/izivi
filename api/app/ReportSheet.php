...
class ReportSheet extends Model
{
    ...
    static function getSpesen($reportSheetId)
    {
        $reportSheet = ReportSheet::join('missions', 'missions.id', '=', 'report_sheets.mission')
            ...
            ->select('report_sheets.start AS meldeblaetter_start',
        ...
        */
        ...
        }else if($resttage_einsatz>= 4 && $resttage_einsatz<=8){
            $verfügbare_krankheitstage+=2;
        }else if($resttage_einsatz>= 9 && $resttage_einsatz<=14){
            $verfügbare_krankheitstage+=3;
        }else if($resttage_einsatz>= 15 && $resttage_einsatz<=21){
            $verfügbare_krankheitstage+=4;
        }else if($resttage_einsatz>= 22 && $resttage_einsatz<=29){
