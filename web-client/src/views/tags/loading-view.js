...
export default class LoadingView extends Component {
    ...
    render(){
        ...
        return (<div style="background:rgba(255,255,255,0.9); width:100%; height:100%; z-index:99999999; position:fixed; left:0px; top:0px; display: table; text-align:center;">
