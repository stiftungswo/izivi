...
export default class AdminRestrictedFields extends Component {
    ...
    getRoleOptions(result) {
        ...
        for(let i = 1; i < 4; i++) {
            ...
            options.push(<option value={i} selected={isSelected}>{roleNames[i]}</option>)
        }
        ...
        return (
            <div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea rows="4" id="internal_note" name="internal_note" class="form-control" onChange={(e) => self.handleTextareaChange(e)}>{result.internal_note}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-3" for="role">Benutzerrolle</label>
                    <div class="col-sm-9">
