                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="btn-group  btn-group-justified" data-toggle="buttons">
                                            <label class="btn btn-default active">
                                                <input type="radio" name="showOnlyDoneSheets" value="1" onchange={(e)=>{this.handleChange(e)}}/> Erledigte Meldeblätter
                                            </label>
                                            <label class="btn btn-default">
                                                <input type="radio" name="showOnlyDoneSheets" value="0" onchange={(e)=>{this.handleChange(e)}}/> Alle Meldeblätter
                                            </label>
                                        </div>
