                ...
                <div className="page page__expense">
                    <Card>
                        ...
                        <div class="btn-group">
                            ...
                            <button class="btn btn-default" data-toggle="modal" data-target="#myModal">Erweitert</button>
                        </div>
                        ...
                        <div class="btn-group">
                            <button class="btn btn-default" onClick={ () => this.getReportSheets('reportsheet') }>Alle Meldeblätter anzeigen</button>
                            <button class="btn btn-default" onClick={ () => this.getReportSheets('reportsheet/pending') }>Pendente Meldeblätter anzeigen</button>
                            <button class="btn btn-default" onClick={ () => this.getReportSheets('reportsheet/current') }>Aktuelle Meldeblätter anzeigen</button>
                        </div>
                        <br />
                        <br />
