		...
		return (
			<div className="page page__expense">
				<Card>
					...
					<button>Spesenstatistiken</button><br/>
					...
					<table border="0" cellspacing="0" cellpadding="2" class="table">
						...
						<tr class="theader">
							<td>&nbsp;</td>
							<td><input type="text" size="5" name="FILTER_ZDP" value=""/></td>
							<td><input type="text" size="40" name="FILTER_NAME" value=""/></td>
							<td><input type="text" size="15" name="FILTER_VON" value=""/></td>
							<td><input type="text" size="15" name="FILTER_BIS" value=""/></td>
							<td></td>
							<td></td>
						</tr>
