        ...
        if(sheet!=null){
            content.push(
				...
				<br /><br />
					...
					<DatePicker id="einsaetze_start" label="Beginn Einsatz" value={sheet.einsaetze_start} callback={this.handleDateChange} callbackOrigin={this} />
					<DatePicker id="einsaetze_end" label="Ende Einsatz" value={sheet.einsaetze_end} callback={this.handleDateChange} callbackOrigin={this} />
					...
					<h3>Gearbeitet</h3>
					<InputField id="meldeblaetter_workdays_proposal" label="Vorschlag" value={sheet.meldeblaetter_workdays_proposal} disabled="true"/>
					<InputField id="meldeblaetter_workdays" label="Wert" value={sheet.meldeblaetter_workdays} />

					<h3>Arbeitsfreie Tage</h3>
					<InputField id="meldeblaetter_workfreedays_proposal" label="Vorschlag" value={sheet.meldeblaetter_workfreedays_proposal} disabled="true"/>
					...
					<InputField id="meldeblaetter_companyurlaub_proposal" label="Vorschlag" value={sheet.meldeblaetter_companyurlaub_proposal} disabled="true"/>
					...
					<InputField id="meldeblaetter_ferien_wegen_urlaub_proposal" label="Vorschlag" value={sheet.meldeblaetter_ferien_wegen_urlaub_proposal} disabled="true"/>
					...
					<h3>Krankheit</h3>
					<InputField id="krankheitstage_verbleibend" label="Übriges Guthaben" value={sheet.krankheitstage_verbleibend + " Tage"} disabled="true"/>
					...
					<h3>Kleiderspesen</h3>
					<InputField id="meldeblaetter_kleider_proposal" label="Wert" value={this.formatRappen(sheet.meldeblaetter_kleider_proposal) + " Fr."} disabled="true"/>
					...
					<InputField id="meldeblaetter_ausserordentlich_comment" label="Bemerkung" value={sheet.meldeblaetter_ausserordentlich_comment} />
