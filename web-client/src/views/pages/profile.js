            ...
            temp.push(
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input class="SWOInput" size="20" id="hometown" name="hometown" value={response.data.TODO} type="text"/></td>
                        <td>Kanton</td>
                        <td align="right">
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            <textarea rows="4" cols="55" class="SWOInput" id="bemerkung" name="bemerkung"></textarea>
                        </td>
                    </tr>
                </tbody>
            );
