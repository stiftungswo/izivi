            ...
            temp.push(
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input class="SWOInput" size="20" id="hometown" name="hometown" value={response.data.hometown} type="text"/></td>
                        <td>Kanton</td>
                        <td align="right">
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="5">
                            <input class="SWOInput" id="account_type_bank" name="account_type" value={response.data.TODO} checked="checked" type="radio"/>Bank
                        </td>
                    </tr>
                    <tr>
                        <td>Name:</td>
                        <td align="right">
                            <div id="help_bank_name"><img src="NoSource" border="0" /></div>
                        </td>
                        <td colspan="4">
                            <input id="bank_name" name="bank_name" class="SWOInput" size="75" autocomplete="off" value={response.data.TODO} type="text"/>
                    ...
                    <tr>
                        ...
                        <td><input class="SWOInput" size="20" id="bank_clearing" name="bank_clearing" value={response.data.TODO} type="text"/></td>
                        <td>Postkonto-Nr:</td>
                        <td align="right">
                            <div id="help_bank_post_account_no"><img src="NoSource" border="0" /></div>
                        </td>
                        <td><input class="SWOInput" size="20" id="bank_post_account_no" name="bank_post_account_no" value={response.data.TODO} type="text"/></td>
                    </tr>
                    <tr>
                        <td>IBAN-Nr.:</td>
                        <td align="right">
                        ...
                        <td colspan="4"><input class="SWOInput" size="75" id="bank_account_no" name="bank_account_no" value={response.data.TODO} type="text"/></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="5"><input class="SWOInput" id="account_type_post" name="account_type" value={response.data.TODO} type="radio"/>Post</td>
                    </tr>
                    <tr>
                        <td>Konto-Nr.:</td>
                        <td align="right">
                        ...
                        <td colspan="4"><input class="SWOInput" size="75" id="post_account_no" name="post_account_no" value={response.data.TODO} disabled="" type="text"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input class="SWOInput" size="20" id="health_insurance" name="health_insurance" value={response.data.TODO} type="text"/></td>
                        <td>Versicherungs-Nr.:</td>
                        <td align="right">
                            <div id="help_health_insurance_no"><img src="NoSource" border="0" /></div>
                        </td>
                        <td><input class="SWOInput" size="20" id="health_insurance_no" name="health_insurance_no" value={response.data.TODO} type="text"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            <textarea rows="4" cols="60" class="SWOInput" id="berufserfahrung" name="berufserfahrung"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td>Führerausweis:</td>
                        ...
                        <td><input value={response.data.TODO} id="fahrausweis" name="fahrausweis" type="checkbox"/> Vorhanden</td>
                    ...
                    <tr>
                        ...
                        <td><input value={response.data.TODO} id="ga" name="ga" type="checkbox"/> Vorhanden</td>
                        <td>Photo:</td>
                        <td align="right">
                            <div id="help_photo"><img src="NoSource" border="0" /></div>
                        </td>
                        <td>
                            <input name="MAX_FILE_SIZE" value="500000" type="hidden"/><input id="imgfile" name="imgfile" type="file"/>
                        </td>
                    </tr>
                    <tr>
                        <td>Halbtax Abo:</td>
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            <textarea rows="4" cols="55" class="SWOInput" id="bemerkung" name="bemerkung">{response.data.internal_note}</textarea>
                        </td>
                    </tr>
                </tbody>
            );
