                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form class="form-horizontal" action="javascript:;" onsubmit={()=>{this.addNewMission()}}>
                                            <div class="form-group">
                                                <label class="control-label col-sm-3" for="newmission_specification">Pflichtenheft</label>
                                                <div class="col-sm-9">
                                                    <select id="newmission_specification" name="newmission_specification" class="form-control" onChange={(e)=>this.handleSelectChange(e)} required>
                                            ...
                                            <InputFieldWithHelpText id="newmission_days" label="Tage" popoverText={howerText_Tage} self={this} disabled="true"/>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-3" for="newmission_trial_mission_comment">Bemerkungen zum Schnuppertag</label>
                                                <div class="col-sm-9">
                                                    <textarea rows="4" id="newmission_trial_mission_comment" name="newmission_trial_mission_comment" class="form-control" onChange={(e)=>this.handleTextareaChange(e)}>{result.internal_note}</textarea>
                                                </div>
                                            </div>
