        ...
        axios.get(
            ...
            temp.push(
                ...
                <div class="form-group">
                    <label class="control-label col-sm-3" for="hometown">Kanton</label>
                    <div class="col-sm-9">
                ...
                <InputFieldWithHelpText id="insurance_nr" label="Versicherungs-Nr." value={response.data.TODO} popoverText={howerText_BankName} />,
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea rows="4" id="berufserfahrung" name="berufserfahrung" class="form-control"></textarea>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea rows="4" id="internal_comment" class="form-control"></textarea>
                    </div>
                </div>,
