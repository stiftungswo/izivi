...
export default class Specifications extends Component {
    ...
    save(i){
        this.setState({loading:true, error:null});
        axios.post(
            ApiService.BASE_URL+'specification/'+this.state.specifications[i].id,
	...
	add(){
        this.setState({loading:true, error:null});
        axios.put(
            ApiService.BASE_URL+'specification/'+this.state.newSpec.id,
            this.state.newSpec,
            { headers: { Authorization: "Bearer " + localStorage.getItem('jwtToken') } }
        ).then((response) => {
    ...
    render() {
            ...
            tbody.push(<tr>
					...
					<td class="col_a">
						<input type="text" size="5"
							   name="short_name"
							   value={specifications[i].short_name}
							   onChange={(e)=>this.handleChange(e, i)}
						/>
					</td>
        ...
        tbody.push(<tr style="background:white;">
				...
				<div className="page page__specification">
					<ScrollableCard>
						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									<th ROWSPAN="2" class="col_a">Aktiv</th>
									<th ROWSPAN="2" class="col_a">ID</th>
									<th ROWSPAN="2" class="col_a">Name</th>
									<th ROWSPAN="2" class="col_a">Short-Name</th>
									<th ROWSPAN="2" class="col_b">Taschengeld</th>
									<th ROWSPAN="2" class="col_a">Unterkunft</th>
									<th ROWSPAN="2" class="col_b">Kleider</th>
									<th COLSPAN="4" class="col_a">Fr&uuml;hst&uuml;ck</th>
									<th COLSPAN="4" class="col_b">Mittagessen</th>
									<th COLSPAN="5"class="col_a">Abendessen</th>
								</tr>
								<tr>
									<td class="col_a" style="text-align:center">Erster Tag</td>
									<td class="col_a" style="text-align:center">Arbeit</td>
									<td class="col_a" style="text-align:center">Frei</td>
									<td class="col_a" style="text-align:center">Letzter Tag</td>
									<td class="col_b" style="text-align:center">Erster Tag</td>
									<td class="col_b" style="text-align:center">Arbeit</td>
									<td class="col_b" style="text-align:center">Frei</td>
									<td class="col_b" style="text-align:center">Letzter Tag</td>
									<td class="col_a" style="text-align:center">Erster Tag</td>
									<td class="col_a" style="text-align:center">Arbeit</td>
									<td class="col_a" style="text-align:center">Frei</td>
									<td class="col_a" style="text-align:center">Letzter Tag</td>
