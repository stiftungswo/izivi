...
export default class UserFeedbackOverview extends Component {
    ...
    getFeedbackQuestions() {
        ...
        axios.get(
            ApiService.BASE_URL+'user/feedback/question',
            { headers: { Authorization: "Bearer " + localStorage.getItem('jwtToken') } }
        ).then((response) => {
            this.setState({loading: false});
                        ...
                        <div class="col-xs-2">
                            <div class="row">
                                 <div class="col-xs-3">
                                     ...
                                     <div class="progress">
                                         <div class="progress-bar progress-bar-danger" style="height: 20%;"></div>
                                     </div>
                                 </div>
                                 <div class="col-xs-3">
                                     <label>{answers[x]['answers'][1]}</label>
                                     <div class="progress">
                                         <div class="progress-bar progress-bar-warning" style="height: 30%;"></div>
                                     </div>
                                 </div>
                                 <div class="col-xs-3">
                                     <label>{answers[x]['answers'][2]}</label>
                                     <div class="progress">
                                         <div class="progress-bar progress-bar-info" style="height: 40%;"></div>
                                     </div>
                                 </div>
                                 <div class="col-xs-3">
                                     <label>{answers[x]['answers'][3]}</label>
                                     <div class="progress">
                                         <div class="progress-bar progress-bar-success" style="height: 50%;"></div>
                                     </div>
                                 </div>
                            </div>
                        </div>
