                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-2">
                                    <div class="progress vertical progress-striped progress-bar-info" style="height: 50px; width: 20px;">
                                        <div class="progress-bar" style={"height: "+(100-(answerFivePerc*100))+"%; width: 100%;  background-color: white;"}></div>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    <div class="progress vertical progress-striped progress-bar-info" style="height: 50px; width: 20px;">
                                        <div class="progress-bar" style={"height: "+(100-(answerSixPerc*100))+"%; width: 100%;  background-color: white;"}></div>
                                    </div>
                                </div>
                            </div>
                        </div>
