                            ...
                            <div class="row">
                                <div class="col-xs-2">
                                    <div class="progress vertical progress-striped" style="height: 50px; width: 20px;">
                                        <div class="progress-bar progress-bar-info" style={"height: "+answerOnePerc*100+"%; width: 100%;"}></div>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    <div class="progress vertical progress-striped" style="height: 50px; width: 20px;">
                                        <div class="progress-bar progress-bar-info" style={"height: "+answerTwoPerc*100+"%; width: 100%;"}></div>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    <div class="progress vertical progress-striped" style="height: 50px; width: 20px;">
                                        <div class="progress-bar progress-bar-info" style={"height: "+answerThreePerc*100+"%; width: 100%;"}></div>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    <div class="progress vertical progress-striped" style="height: 50px; width: 20px;">
                                        <div class="progress-bar progress-bar-info" style={"height: "+answerFourPerc*100+"%; width: 100%;"}></div>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    <div class="progress vertical progress-striped" style="height: 50px; width: 20px;">
                                        <div class="progress-bar progress-bar-info" style={"height: "+answerFivePerc*100+"%; width: 100%;"}></div>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    <div class="progress vertical progress-striped" style="height: 50px; width: 20px;">
                                        <div class="progress-bar progress-bar-info" style={"height: "+answerSixPerc*100+"%; width: 100%;"}></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-3">
                                    ...
                                    <div class="progress vertical progress-striped" style="height: 50px">
                                        <div class="progress-bar progress-bar-danger" style={"height: "+answerOnePerc*100+"%; width: 100%;"}></div>
                                    </div>
                                </div>
                                <div class="col-xs-3">
                                    <label>{answers[x]['answers']['2']}</label>
                                    <div class="progress vertical progress-striped" style="height: 50px">
                                        <div class="progress-bar progress-bar-warning" style={"height: "+answerTwoPerc*100+"%; width: 100%;"}></div>
                                    </div>
                                </div>
                                <div class="col-xs-3">
                                ...
                                <div class="col-xs-3">
                                    ...
                                    <div class="progress vertical progress-striped" style="height: 50px">
                                        <div class="progress-bar progress-bar-success" style={"height: "+answerFourPerc*100+"%; width: 100%;"}></div>
                                    </div>
                                </div>
                            </div>
                        </div>
