			...
			<Header>
				<div className="page page__register">
					<Card>
						...
						<div class="container">
							{this.state.errorBox}
							<form id="registerForm" action="javascript:;" onSubmit={() => this.register()} class="form-horizontal" data-toggle="validator">
								<hr />
								...
								<div class="form-group has-feedback">
									<label class="control-label col-sm-3" for="password_confirm">Passwort Bestätigung:</label>
									<div class="col-sm-9">
										<input
											type="password"
											id="password_confirm"
