		...
		<div className="page page__home">
			...
			<Card>
				...
				<ul>
					...
					<li>Photo: Optional, hilft uns Namen und Gesichter zu assozieren. Damit werden wir deinen Namen schon beim ersten mal kennen. Beachte : JPEG/GIF/BMP, Max 512kb</li>
				</ul>
				<p>Wichtig: Vergiss nicht zu speichern (Daten speichern) bevor du die Seite verlässt oder eine Einsatzplanung erfasst.</p>
				<p>Am Ende der Seite findest du eine Liste deiner Einsatzplanungen. Ist diese leer, so hast du noch keine Einsatzplanung erfasst. Siehe nächstes Kapitel. Klicke auf den Link drucken so wird ein PDF der Einsatzplanung generiert und in einem neuen Fenster angezeigt. Dieses kannst du dann drucken und an den Einsatzbetrieb schicken.</p>
			</Card>
			<Card>
			...
			<Card>
				...
				<p>Nach Absprache mit der Einsatzleitung kannst du auch einen Einsatz verlängern. Erfasse dazu eine neue Einsatzplanung, welche als Startdatum den Tag nach Einsatzende der vorhergehenden Einsatzplanung hat. Drucke diese Einsatzplanung und lasse sie von der Einsatzleitung unterschreiben.</p>
			</Card>
		</div>
	);
}
